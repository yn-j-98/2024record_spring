...
public class MemberDAO implements MemberService {
	...
	private final String SEARCH_ONE = "SELECT MEMBER_NUM, MEMBER_ID, MEMBER_PASSWORD FROM MEMBER WHERE MEMBER_ID = ? AND MEMBER_PASSWORD = ?"; // 로그인
	private final String INSERT = "INSERT INTO MEMBER (MEMBER_ID, MEMBER_PASSWORD) VALUES (?, ?)"; // 회원가입
